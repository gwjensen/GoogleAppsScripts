...
function submitFormInformation(form) {
  ...
  try {
    ...
    if (files.hasNext()) {
       ...
       sheet.appendRow([myDate, form.matrikulation, form.university,form.email,form.rateLecture, FileNameURL, form.question1, form.question2,form.question3, form.question4])
       if (late){
